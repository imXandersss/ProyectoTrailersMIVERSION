...
exports.remove = exports.getOne = exports.put = exports.post = exports.get = void 0;
...
var get = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Course_model_1.default.find()];
            case 1:
                data = _a.sent();
...
var post = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        try {
            ...
            newCourse.save(function () { return res.status(200).json({ Message: 'Course created correctly' }); });
        }
        catch (err) {
            console.log(err);
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, Course_model_1.default.findByIdAndUpdate(id, { set: newCourse }, { new: true })];
            case 1:
                _b.sent();
                return [2 /*return*/, res.status(200).json({ Message: 'Course updated succesfully' })];
            case 2:
                err_2 = _b.sent();
                console.log(err_2);
                return [2 /*return*/, res.status(500).json({ Message: 'Error', Error: err_2 })];
            case 3: return [2 /*return*/];
        }
    });
}); };
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, Course_model_1.default.findByIdAndRemove(id)];
            case 1:
                _a.sent();
                return [2 /*return*/, res.status(200).json({ Message: 'Course removed succesfully' })];
            case 2:
                err_4 = _a.sent();
                console.log(err_4);
